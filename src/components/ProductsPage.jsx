...
const ProductsPage = ({ setCurrentPage }) => {
  ...
  const products = {
    aifag: {
      ...
      description:
        "Connect, configure, and deploy intelligent AI agents across your organization. Automate complex workflows with human-like reasoning.",
      features: [
        {
          icon: (
            <svg
    ...
    lifeos: {
      ...
      description:
        "Your intelligent life companion. Organize, plan, and optimize every aspect of your personal and professional life.",
      features: [
        {
          icon: (
            <svg
  ...
  return (
    <div className="bg-black text-white min-h-screen px-4 sm:px-8 md:px-16 lg:px-32">
      {/* Header Section */}
      <div
        ref={sectionRefs[sectionIdx]}
        className={`pt-32 pb-24 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12">
            Two revolutionary AI ecosystems designed to transform how
            enterprises operate and individuals live.
          </p>
      ...
      <div
        id="product-showcase"
        ref={sectionRefs[sectionIdx]}
        className={`pb-24 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
      >
              ...
              {selectedProduct === "aifag" ? (
                <>
                  ...
                  <p className="text-lg text-gray-400 mb-8 leading-relaxed">
                    From learner to founder, everyone can create AI agents to
                    make life easier.
                  </p>

                  {/* Second Description */}
                  <p className="text-lg text-gray-400 mb-12 leading-relaxed">
                    Build intelligent agents without coding. Showcase your
                    creations to potential employers. Companies discover talent
                    through their agent portfolios and make hiring decisions
                ...
                <>
                  ...
                  <p className="text-lg text-gray-400 mb-12 leading-relaxed">
                    ...
                    understands your goals, and helps you optimize every aspect
                ...
                <div className="bg-neutral-800/50 border border-gray-700 rounded-3xl p-8 w-full max-w-lg">
                  ...
                  <div>
                    <p className="text-gray-200 text-base leading-relaxed mb-4">
                      "Based on your schedule, I recommend tackling the
                      presentation before lunch when your focus peaks."
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  AI-powered scheduling that adapts to your priorities and
                  energy levels.
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  Set, track, and achieve your goals with intelligent progress
                  monitoring.
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  Balance work and life with health-aware recommendations.
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  Smart task prioritization and delegation suggestions.
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  Track spending and receive personalized financial guidance.
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                ...
                <p className="text-gray-400">
                  Never miss important dates or follow-ups with your network.
                </p>
              </div>
            </div>
          </div>
      ...
      {selectedProduct === "lifeos" && (
        <div
          ref={sectionRefs[sectionIdx]}
          className={`py-24 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
        >
          <div className="max-w-4xl mx-auto text-center">
            {/* Main Heading */}
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
              ...
              <div className="relative bg-neutral-900 border border-gray-800 rounded-2xl p-8 flex flex-col items-center text-center hover:border-gray-700 transition duration-200">
                ...
                {/* Description */}
                <p className="text-gray-400 leading-relaxed">
                  Launch intelligent automation across your organization
                  instantly.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 flex gap-6 hover:border-gray-700 transition duration-200">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Coordinate multiple AI agents working together on complex
                    tasks.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 flex gap-6 hover:border-gray-700 transition duration-200">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Connect with 200+ enterprise tools and platforms out of the
                    box.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 flex gap-6 hover:border-gray-700 transition duration-200">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    SOC 2 compliant with end-to-end encryption and access
                    controls.
                  </p>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 hover:bg-neutral-800/50 transition duration-200 cursor-pointer">
                ...
                <p className="text-gray-400">
                  Collect sales data, analyze trends, generate report, email to
                  team
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 hover:bg-neutral-800/50 transition duration-200 cursor-pointer">
                ...
                <p className="text-gray-400">
                  Monitor tickets, categorize urgency, assign to agents, send
                  updates
                </p>
              </div>
              ...
              <div className="bg-neutral-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 hover:bg-neutral-800/50 transition duration-200 cursor-pointer">
                ...
                <p className="text-gray-400">
                  Research topics, generate drafts, review quality, schedule
                  posts
                </p>
              </div>
            </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Subheading */}
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12">
            Join our early access program and shape the next generation of AI
            products.
          </p>
