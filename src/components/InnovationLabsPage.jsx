  ...
  return (
    <div className="bg-black text-white min-h-screen px-4 sm:px-8 md:px-16 lg:px-32">
      ...
      <div
        ...
        className={`pt-16 pb-20 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
      >
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="mb-4 inline-flex items-center gap-2 bg-gray-900 border border-gray-800 rounded-full px-4 py-2">
            <svg
          ...
          {/* Main Heading */}
          <h1 className="text-5xl md:text-7xl font-semibold mb-4 text-white">
            Innovation Labs
          </h1>
      ...
      <div
        ref={sectionRefs[sectionIdx]}
        className={`sticky top-16 z-40 bg-gray-900/50 border-b border-gray-800 backdrop-blur-sm transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
      >
      ...
      <div
        ref={sectionRefs[sectionIdx]}
        className={`py-12 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
      >
          ...
          {activeTab === "partners" && (
            <div>
              <div className="text-center mb-8">
                ...
                <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                  Collaboration is at the heart of innovation. We work with
              ...
              <div className="max-w-7xl mx-auto mb-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200 text-center">
                    ...
                    <p className="text-gray-400">Research Partnerships</p>
                  </div>
                  ...
                  <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200 text-center">
                    ...
                    <p className="text-gray-400">Industry Partnerships</p>
                  </div>
                  ...
                  <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200 text-center">
                    ...
                    <p className="text-gray-400">Startups Partnerships</p>
                  </div>
                </div>
              </div>
          ...
          {activeTab === "launch" && (
            <div>
              <div className="text-center mb-8">
                ...
                <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
                  Our journey to launching AIFAG and LifeOS as the next
                  generation of AI ecosystems.
                </p>
              </div>
              ...
              <div className="max-w-3xl mx-auto relative pl-8">
                ...
                <div className="relative flex">
                  ...
                  <div className="bg-neutral-900 border border-gray-800 rounded-xl p-6 hover:border-gray-700 transition duration-200 flex-1">
                    ...
                    <h3 className="text-2xl font-bold text-white mb-4">
                      Global Campaign & Public Release
                    </h3>
                    <div className="flex justify-end">
                      <span className="px-3 py-1 bg-gray-800 border border-gray-700 text-gray-400 rounded-full text-xs font-semibold">
                        upcoming
      ...
      {activeTab !== "prototypes" &&
        ...
        activeTab !== "launch" && (
          <div
            ref={sectionRefs[sectionIdx]}
            className={`pb-12 px-4 transition-all duration-700 ${reveals[sectionIdx++] ? "fade-in-up" : "opacity-0"}`}
          >
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                  ...
                  {/* Description */}
                  <p className="text-gray-400">
                    Pushing the boundaries of natural language understanding and
                    generation.
                  </p>
                </div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                  ...
                  {/* Description */}
                  <p className="text-gray-400">
                    Bringing powerful AI capabilities to resource-constrained
                    devices.
                  </p>
                </div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                  ...
                  {/* Description */}
                  <p className="text-gray-400">
                    Developing frameworks for coordinated AI agent
                    collaboration.
                  </p>
                </div>
                ...
                <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8 hover:border-gray-700 transition duration-200">
                  ...
                  {/* Description */}
                  <p className="text-gray-400">
                    Making AI decisions transparent and interpretable for
                    humans.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12">
            Whether you're a researcher, enterprise, or startup — there's a
