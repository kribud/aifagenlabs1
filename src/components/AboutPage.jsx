      ...
      <div ref={storyRef}>
        <div className="max-w-full mx-auto bg-neutral-800 px-8 sm:px-12 md:px-24 py-8 sm:py-12 md:py-20">
          ...
          <div className="space-y-8 text-lg text-gray-400 leading-relaxed">
            {/* Paragraph 1 */}
            <p>
              AIFAGen Labs was founded in 2025 with a simple yet powerful
              belief: AI should be for everyone — not just large tech companies.
            </p>
            ...
            <p>
              ...
              <span className="text-white font-bold">AIFAG</span> and{" "}
              <span className="text-white font-bold">LifeOS</span>.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-gray-700 transition duration-200">
              ...
              <p className="text-gray-400 leading-relaxed">
                Deliver next-generation, human-centric AI solutions that
                transform businesses and empower individuals by enhancing human
                capabilities.
              </p>
            </div>
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-3xl p-8 hover:border-gray-700 transition duration-200">
              ...
              {/* Description */}
              <p className="text-gray-400 leading-relaxed">
                Make AI accessible, meaningful, and scalable — from startups to
                global enterprises.
              </p>
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            ...
            researchers, and product builders focused on responsible and
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 justify-center max-w-2xl mx-auto">
            ...
            <div className="bg-gray-900/50 border border-gray-800 rounded-2xl p-6 hover:border-gray-700 transition duration-200">
              <div className="flex items-start gap-3 mb-4">
                ...
                <div className="text-left">
                  <h3 className="text-lg font-bold text-white">New Jersey</h3>
